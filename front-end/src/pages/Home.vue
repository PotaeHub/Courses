...
<template>
    <div class="min-h-screen bg-[#F5F2F2]">
        <section v-if="!auth.user" class="relative overflow-hidden bg-[#0F172A] py-32 text-center text-white">
            <div
                class="absolute top-0 left-1/2 -translate-x-1/2 w-[800px] h-[500px] bg-blue-600/20 blur-[120px] rounded-full">
            </div>
            ...
            <div class="relative z-10 max-w-3xl mx-auto px-6">
                ...
                <p class="mb-12 text-gray-400 text-lg font-light leading-relaxed">
                    สมัครสมาชิกวันนี้เพื่อรับสิทธิพิเศษและเริ่มสร้างทักษะใหม่ที่ตลาดต้องการ <br
        ...
        <section v-else class="relative overflow-hidden bg-[#BDE8F5] pt-24 pb-32">
            <div
                class="absolute top-0 right-0 w-[500px] h-[500px] bg-blue-50/50 rounded-full blur-[100px] -mr-32 -mt-32">
            </div>
            ...
            <div class="max-w-7xl mx-auto px-6 relative z-10">
                <div class="flex flex-col md:flex-row md:items-end justify-between gap-10">
                    <div class="space-y-4">
                        <div
                            class="inline-flex items-center gap-2.5 bg-blue-50 text-blue-400 px-5 py-2 rounded-full text-xs font-black uppercase tracking-widest">
                    ...
                    <button @click="$router.push('/student/mycourses')"
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg"
                            class="h-5 w-5 group-hover:rotate-12 transition-transform" fill="none" viewBox="0 0 24 24"
                            stroke="currentColor">
                ...
                <div class="mt-16 max-w-2xl group">
                    <div
                        class="p-[1.5px] rounded-[2rem] bg-gradient-to-r from-gray-200 via-gray-100 to-gray-200 group-focus-within:from-blue-400 group-focus-within:to-indigo-400 transition-all duration-500">
                        <div class="flex items-center px-7 py-5 bg-white rounded-[1.95rem]">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 text-gray-300 mr-4" fill="none"
        ...
        <div class="max-w-7xl mx-auto px-6 -mt-10 relative z-20">
            <div
                class="grid grid-cols-2 md:grid-cols-4 gap-4 bg-white/80 backdrop-blur-xl p-10 rounded-[3rem] shadow-[0_20px_50px_rgba(0,0,0,0.04)] border border-white/50">
                <div v-for="(stat, index) in [
                    ...
                    <div class="text-[10px] text-gray-400 uppercase font-black tracking-[0.2em] mt-2">{{ stat.label }}
                    </div>
                </div>
            </div>
        </div>
            ...
            <template v-else>
                <section class="space-y-10">
                    <div class="flex items-end justify-between">
                        ...
                        <button @click="AllCourse"
                            class="group text-blue-600 font-bold text-sm flex items-center gap-2 hover:gap-4 transition-all">
                            ดูทั้งหมด <span class="text-xl">→</span>
                        </button>
                    </div>
                    <PopularCourses :courses="filteredPopularCourses" />
                    <div v-if="filteredPopularCourses.length === 0"
                        class="text-center py-24 bg-gray-50 rounded-[3rem] border border-dashed border-gray-200">
                ...
                <section class="space-y-10 pb-32">
                    ...
                    <div v-if="filteredLatestCourses.length === 0"
                        class="text-center py-24 bg-gray-50 rounded-[3rem] border border-dashed border-gray-200">
                        <p class="text-gray-400 font-medium">ไม่พบข้อมูลในหมวดหมู่นี้</p>
                    </div>
                </section>
